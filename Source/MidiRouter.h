...
/**
    ...
    do host está em modo solo (ver PluginHostEngine::setPluginSolo e o modo
    Exclusive, que garante no momento do clique que só um solo fica ativo
    por vez - o roteador em si não precisa saber que o modo Exclusive existe).
