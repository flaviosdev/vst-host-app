                        ...
                        juce::MidiBuffer& destination)
{
    ...
    // prioridade - é o comportamento padrão em DAWs). O modo Exclusive não
    // muda essa regra em si - ele só garante, no momento do clique em Solo
    // (ver PluginHostEngine::setPluginSolo), que nunca existe mais de um
    // plugin em solo ao mesmo tempo.
